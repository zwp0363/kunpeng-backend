...
import com.zwp.kunpeng.judge.codesandbox.CodeSandboxFactory;
import com.zwp.kunpeng.judge.codesandbox.CodeSandboxProxy;
...
public class JudgeServiceImpl implements JudgeService {
    ...
    public QuestionSubmit doJudge(long questionSubmitId) {
        ...
        // 3.等待状态则更改判题（提交题目）状态为“判题中”，防止重复执行
        ...
        List<JudgeCase> judgeCaseList = JSONUtil.toList(judgeCaseStr, JudgeCase.class);// 转换为json数组
